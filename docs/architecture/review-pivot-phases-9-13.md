...
```go
// agents/agents.go
import agentrepo "github.com/twistingmercury/mnemonic-api/internal/repository/agent"
...
import patternrepo "github.com/twistingmercury/mnemonic-api/internal/repository/pattern"
